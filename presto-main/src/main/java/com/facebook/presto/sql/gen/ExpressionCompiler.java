...
public class ExpressionCompiler
{
    ...
    {
        // remove fake string filters (like push-down hack)
        LikeHackUtility likeHackUtility = new LikeHackUtility();
        filter = likeHackUtility.removeFakeStringFilters(filter);
