...
{
    private static final HostAddress address = HostAddress.fromParts("localhost", 4433);
    ...
    private static void assertData(HyenaSession hyenaSession, HyenaMetadata metadata)
    {
        ...
        HyenaRecordSet recordSet = new HyenaRecordSet(hyenaSession, new HyenaSplit(address, UUID.randomUUID(), TupleDomain.all()), columnHandles);
